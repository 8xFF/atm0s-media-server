...
pub async fn run_token_generate_server(http_port: u16, _opts: TokenGenerateArgs, token: &str, token_signer: Arc<dyn SessionTokenSigner + Send + Sync>) -> Result<(), &'static str> {
