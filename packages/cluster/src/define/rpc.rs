...
pub const RPC_SIP_INVITE_OUTGOING_CLIENT: &str = "RPC_SIP_INVITE_OUTGOING_CLIENT";
pub const RPC_SIP_INVITE_OUTGOING_SERVER: &str = "RPC_SIP_INVITE_OUTGOING_SERVER";
pub const RPC_SIP_INCOMING_REGISTER_REQUEST: &str = "RPC_SIP_INCOMING_REGISTER_REQUEST";
pub const RPC_SIP_INCOMING_REGISTER_RESPONSE: &str = "RPC_SIP_INCOMING_REGISTER_RESPONSE";
pub const RPC_SIP_INCOMING_SIP_INVITE_REQUEST: &str = "RPC_SIP_INCOMING_SIP_INVITE_REQUEST";
pub const RPC_SIP_INCOMING_SIP_INVITE_RESPONSE: &str = "RPC_SIP_INCOMING_SIP_INVITE_RESPONSE";
