...
impl RecordConverter {
    ...
    pub async fn convert(&self) -> Result<(String, RecordSummary), String> {
        ...
        for peer in peers {
            ...
            for mut session in sessions {
                ...
                tokio::spawn(async move {
                    ...
                    let mut media = SessionMediaWriter::new(tmp_folder, &session_prefix);
        ...
        if let Some(out_s3) = self.out_s3.as_ref() {
            ...
            Ok((summary_key.to_string(), record_summary))
        } else {
